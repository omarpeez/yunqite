...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Yunqi — Té Premium Embotellado" },
      { name: "description", content: "Saludable, antioxidante y refrescante. Yunqi té el mejor té de oolong del mundo" },
      { name: "author", content: "Verde" },
      { property: "og:title", content: "Yunqi — Té Premium Embotellado" },
      { property: "og:description", content: "Saludable, antioxidante y refrescante. Yunqi té el mejor té de oolong del mundo" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Yunqi — Té Premium Embotellado" },
      { name: "twitter:description", content: "Saludable, antioxidante y refrescante. Yunqi té el mejor té de oolong del mundo" },
